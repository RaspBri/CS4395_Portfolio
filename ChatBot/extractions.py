    ...
    if os.path.isfile('{}_data.json'.format(name)):
        ...
        for intent in data['intents']:
            for pattern in intent['patterns']:
                if 'I like' in intent['patterns']:
                    responses = intent['responses']
                elif 'I hate' in intent['patterns']:
                    responses_d = intent['responses']
        likes = random.choice(responses)
        dislikes = random.choice(responses_d)
        print("Welcome back! I remember last time you said you liked {}, I hope you got around to that after we chatted and avoided {}.".format(likes, dislikes))
        os.system(cmd)
    else:
        # get topic from user
